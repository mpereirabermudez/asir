...
function ip_recon() {
    ...
    do
        ...
        then
            ...
            then
                echo -e "\t${red}[+] ${green}Host ${yellow}$ip_addr ${green}at ${yellow}$mac_addr ${green}is UP ${yellow}22/tcp open ssh${reset}"
            else
            echo -e "\t${red}[+] ${green}Host ${yellow}$ip_addr ${green}at ${yellow}$mac_addr ${green}is UP${reset}" 
            fi
        fi
        } &
    done
